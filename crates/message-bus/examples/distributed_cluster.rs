...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    match node1.request("cluster/ping", request, Duration::from_secs(5)).await {
        Ok(response) => {
